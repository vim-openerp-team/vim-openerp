...
syn keyword pgsqlKeyword	 index into immutable inner initially immediate inherits instead insert in inout if
...
syn keyword pgsqlKeyword	 verbose view values varying vacuum varchar
